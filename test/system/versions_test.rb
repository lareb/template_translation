...
class VersionsTest < ApplicationSystemTestCase
  ...
  test "creating a Version" do
    ...
    fill_in "Html body", with: @version.html_body
    fill_in "Translation json", with: @version.translation_json
    fill_in "Translation text", with: @version.translation_text_id
