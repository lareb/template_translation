...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { html_body: @version.html_body, translation_json: @version.translation_json, translation_text_id: @version.translation_text_id } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { html_body: @version.html_body, translation_json: @version.translation_json, translation_text_id: @version.translation_text_id } }
